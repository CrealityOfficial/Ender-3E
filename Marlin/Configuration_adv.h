...
#define BLTOUCH_DELAY 500   // Creality enable delay for increase security and accuracy
 ...
 */
#define NO_SD_HOST_DRIVE   // Disable SD Card access over USB (for security). //禁用通过 USB 访问 SD 卡（为了安全）。
