...
//USART SERIAL SCREEN CONTROL COME FORM Accessories Division
// #define SERIAL_CTRL_SCREEN

//usr to hight temp to 300
// #define HIGHT_TEMP


// Author info of this build printed to the host during boot and M115
#define STRING_CONFIG_H_AUTHOR "Ender-3 E" // Who made the changes. 
...
#define CUSTOM_MACHINE_NAME "Ender-3 E"
 ...
 */
#ifdef HIGHT_TEMP
  #define NOZZLE_TO_PROBE_OFFSET { -30, -50, 0 }   //{ -40, -40, 0 }
#else
  #define NOZZLE_TO_PROBE_OFFSET { -43, -10, 0 }   //{ -40, -40, 0 }
#endif
...
//
// Ender-5 Pro v2 OEM display. A DWIN display with Rotary Encoder.
//
