...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_BLTOUCH                         = _UxGT("CRTouch");
  ...
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_5V           = _UxGT("Set CRTouch to 5V");
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_OD           = _UxGT("Set CRTouch to OD");
